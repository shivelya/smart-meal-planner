...
namespace Backend.Services
{
    public interface IMealPlanService
    {
        ...
        Task<GetMealPlansResult> GetMealPlansAsync(int userId, int? skip, int? take, CancellationToken ct);
        /// <summary>
        ...
        Task<MealPlanDto> AddMealPlanAsync(int userId, CreateUpdateMealPlanRequestDto request, CancellationToken ct);
        /// <summary>
        ...
        Task<MealPlanDto> UpdateMealPlanAsync(int id, int userId, CreateUpdateMealPlanRequestDto request, CancellationToken ct);
        /// <summary>
        ...
        Task<bool> DeleteMealPlanAsync(int id, int userId, CancellationToken ct);
        /// <summary>
        ...
        Task<CreateUpdateMealPlanRequestDto> GenerateMealPlanAsync(GenerateMealPlanRequestDto request, int userId, CancellationToken ct);
        /// <summary>
        ...
        Task<GetPantryItemsResult> CookMealAsync(int id, int mealEntryId, int userId, CancellationToken ct);
    }
}
